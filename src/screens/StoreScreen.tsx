...
export default function StoreScreen({ onBack, userCoins }: Props) {
    ...
    return (
        <div className="store-container">
            ...
            <nav className="store-tabs">
                <button
                    className={`tab-item ${activeTab === 'coins' ? 'active' : ''}`}
                ...
                <button
                    className={`tab-item ${activeTab === 'tables' ? 'active' : ''}`}
                    ...
                    {filteredItems.map(item => (
                        <div key={item.id} className="store-card">
                            ...
                            <div className="item-preview">
                                {/* Preview Logic based on category */}
                                {item.category === 'cards' ? (
                                    <div
                                    ...
                                    >
                                        {!item.image.endsWith('.png') && (
                                            <>
                                                ...
                                                <div className="card-center-logo">{item.id.charAt(1)}</div>
                                            </>
                                        )}
                                    </div>
